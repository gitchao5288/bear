        ...
        <form class="layui-form">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-block">
                  <input type="radio" name="sex" value="m" lay-skin="primary" title="男">
                  <input type="radio" name="sex" value="w" checked lay-skin="primary" title="女">
              </div>
          </div>
          <div class="layui-form-item">
              <label class="layui-form-label"><span class="x-red">*</span>权限</label>
              <div class="layui-input-block">
                 <input type="radio" name="auth" value="0" lay-skin="primary" title="超级管理员">
                 <input type="radio" name="auth" value="1" checked lay-skin="primary" title="普通管理员">
              </div>
          </div>
          <div class="layui-form-item">
