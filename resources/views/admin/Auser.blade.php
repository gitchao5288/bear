  ...
  <body>
    ...
    <div class="x-body">
      ...
      <xblock>
        ...
        <button class="layui-btn" onclick="x_admin_show('添加用户','/admins/User/create')"><i class="layui-icon"></i>添加</button>
        ...
        <tbody>
          <tr>
            ...
            <td class="td-manage">
              ...
              <a title="编辑"  onclick="x_admin_show('编辑','/admins/Useredit')" href="javascript:;">
                <i class="layui-icon">&#xe642;</i>
              </a>
