...
<head>
    ...
    <link rel="shortcut icon" href="/admin/index/favicon.ico">
    <link href="/admin/index/css/bootstrap.min.css-v=3.3.5.css"  rel="stylesheet">
    <!-- <link href="/admin/index/css/font-awesome.min.css-v=4.4.0.css"   rel="stylesheet"> -->
    <link href="https://cdn.bootcss.com/font-awesome/4.7.0/css/font-awesome.css" rel="stylesheet">
    <link href="/admin/index/css/animate.min.css"  rel="stylesheet">
    <link href="/admin/index/css/style.min.css-v=4.0.0.css" rel="stylesheet">
</head>
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="#">后台用户 <span class="fa arrow"></span></a>
                                    <ul class="nav nav-third-level">
                                        <li><a class="J_menuItem" href="/admins/User" tppabs="http://www.zi-han.net/theme/hplus/form_webuploader.html">用户浏览</a>
                                        </li>
...
>>>>>>> bear/yangkun
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="/admins/Order" tppabs="http://www.zi-han.net/theme/hplus/contacts.html">订单列表</a>
                            </li>
                        </ul>
                    </li>
            ...
            <div class="row content-tabs">
                ...
                <nav class="page-tabs J_menuTabs">
                    <div class="page-tabs-content">
                        <a href="/admins/wel" class="active J_menuTab" data-id="index_v1.html">首页</a>
                    </div>
                </nav>
...
>>>>>>> bear/yangkun
                    ...
                    <div id="tab-2" class="tab-pane">
                        ...
                        <div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/admin/index/img/a1.jpg" tppabs="http://www.zi-han.net/theme/hplus/img/a1.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/admin/index/img/a2.jpg" tppabs="http://www.zi-han.net/theme/hplus/img/a2.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/admin/index/img/a3.jpg" tppabs="http://www.zi-han.net/theme/hplus/img/a3.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/admin/index/img/a4.jpg" tppabs="http://www.zi-han.net/theme/hplus/img/a4.jpg">
                                    </div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/admin/index/img/a8.jpg" tppabs="http://www.zi-han.net/theme/hplus/img/a8.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/admin/index/img/a7.jpg" tppabs="http://www.zi-han.net/theme/hplus/img/a7.jpg">
                                    </div>
                                    <div class="media-body">
    ...
    <script src="/admin/index/js/plugins/metisMenu/jquery.metisMenu.js" tppabs="http://www.zi-han.net/theme/hplus/js/plugins/metisMenu/jquery.metisMenu.js"></script>
    <script src="/admin/index/js/plugins/slimscroll/jquery.slimscroll.min.js" tppabs="http://www.zi-han.net/theme/hplus/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
    <script src="/admin/index/js/plugins/layer/layer.min.js" tppabs="http://www.zi-han.net/theme/hplus/js/plugins/layer/layer.min.js"></script>
