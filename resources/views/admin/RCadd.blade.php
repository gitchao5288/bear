    ...
    <div class="x-body">
        <form class="layui-form">
          ...
          <!-- 隐藏 -->
           <div class="layui-form-item layui-form-text">
                ...
                <div class="layui-input-block">
                    <input type="hidden" name='feilname' value="">
                    <img id="art_thumb" src="" style="width:500px; position: absolute; left: 300px; top: -200px;">
                </div>
            </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-block">
                  <input type="radio" name="rstatus" value="1" lay-skin="primary" title="开启">
                  <input type="radio" name="rstatus" value="0" checked lay-skin="primary" title="关闭">
              </div>
          </div>
          <div class="layui-form-item">
