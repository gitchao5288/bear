    ...
    <form class="layui-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="password" id="password" name= "pass" value="" required="" lay-verify="required"
                       autocomplete="off" class="layui-input">
            </div>
            <input type="hidden" name="uname" value="{{session('adminName')}}">
...
<script>
    layui.use(['form','layer'], function(){
        ...
        form.on('submit(edit)', function(data){
            ...
            //ajax处理添加
            $.post('/admins/User/pedit',data.field,function(data){
                if(data.status==1){
