...
<div class="x-body">
    <form class="layui-form" action="/admins/cate/update">
        <div class="layui-form-item">
            <label for="username" class="layui-form-label">
                <span class="x-red">*</span>类别原名
            </label>
            <div class="layui-input-inline">
                <input type="text" id="username" readonly value="{{ $data->cate_name }}" required="" lay-verify="required"
                       autocomplete="off" class="layui-input">
            </div>
            <input type="hidden" name="id" value="{{ $data->id }}">
            <div class="layui-form-mid layui-word-aux">
                <span class="x-red">*</span>原类别名称
            </div>
        </div>
        <div class="layui-form-item">
            <label for="username" class="layui-form-label">
                <span class="x-red">*</span>将修改为
            </label>
            <div class="layui-input-inline">
