										...
										<ul class="category-list" id="js_climit_li">
											...
											<li class="appliance js_toggle relative first">
												...
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="/home/basic/images2/cake.png"></i><a class="ml-22" title="点心">{{$v['cate_name']}}</a></h3>
													<em>&gt;</em></div>
													...
													<div class="area-in">
														<div class="area-bg">
															<div class="menu-srot">
																...
																<div class="sort-side">
																	<dl class="dl-sort">
																		<dt><span title="蛋糕">{{$n['cate_name']}}</span></dt>
																			@foreach($arr as $m)
																			@if($m['pid']==$n['id'])
																			<dd><a href="" title="">{{$m['cate_name']}}</a></dd>
																			@endif
																			@endforeach
																	</dl>
																</div>
